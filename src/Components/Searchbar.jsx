...
import { MdKeyboardArrowRight, MdOutlineShortText } from "react-icons/md";
  ...
  return (
    <section className='search_bar bg-[#F5F5F3] relative z-10'>
        <Container className='flex justify-between items-center md:py-[25px] p-2 md:px-0 relative'>
            <div onClick={()=> setShow(!show)} className="category flex gap-[10px] items-center hover:cursor-pointer">
            ...
            <div className="cart-login flex items-center md:gap-x-10 gap-x-2 text-[#262626]">
                <div onClick={()=> setUser(!user)} className="user flex items-center hover:cursor-pointer md:text-base text-xs relative">
                    <FaUser />
                ...
                <div onClick={()=> setCart(!cart)} className="cart hover:cursor-pointer md:text-base text-xs relative">
                    <FaShoppingCart />
                    <div className={`absolute top-full translate-y-4 right-0 border border-[#F0F0F0] transition-all duration-300 ${ cart ? "opacity-100 visible" : "opacity-0 invisible" }`}>
                        ...
                        <div className="pay md:px-5 px-3 md:pt-[14px] pt-2 md:pb-5 pb-3 bg-[#FFF]">
                            <p className='mb-3'>
                            <span className='md:text-base text-xs text-[#767676] leading-[143.75%]'>Subtotal:</span> <span className='md:text-base text-xs text-[#262626] md:font-bold font-medium'>$44.00</span>
                            </p>
